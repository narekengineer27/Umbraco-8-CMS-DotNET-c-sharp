namespace TotalCode.Core.Controllers.Pages
{
    ...
    public class TotalCodeWithdrawBankPageController : BasePageController
    {
        private readonly ICardService _cardService;
        private readonly IContentService _contentService;

        public TotalCodeWithdrawBankPageController(ICardService cardService, IContentService contentService)
        {
        ...
        {
            var model = GetModel<WithdrawBankPageViewModel>(CurrentPage);
            ...
            var activeCardsResponse = (ActiveCardResponseContent)await _cardService.ActiveCards(model.TenantUid, model.Token, origin);
