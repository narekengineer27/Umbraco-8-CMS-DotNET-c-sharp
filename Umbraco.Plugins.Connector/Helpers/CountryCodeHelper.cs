namespace Umbraco.Plugins.Connector.Helpers
{
    ...
    public static class CountryHelper
    {
        ...
        public static Country GetEnum(string searchField)
        {
            return Country.GetValues(typeof(Country)).Cast<Country>().FirstOrDefault(v => string.Equals(v.GetCountryLanguageIsoCode(), searchField, StringComparison.OrdinalIgnoreCase) || string.Equals(v.GetCountryLanguageName(), searchField, StringComparison.OrdinalIgnoreCase));
        }
        ...
        {
            var alpha2 = ISO3166.GetCollection().SingleOrDefault(x => x.Alpha3 == countryCode)?.Alpha2;
