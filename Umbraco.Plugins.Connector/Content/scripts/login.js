$(function () {
    ...
    if (Cookies.get('username') !== undefined) {
        ...
        if (loginInfo.lastLogin !== undefined) {
            var expiresAt = new Date(lastLogin.getUTCFullYear(), lastLogin.getUTCMonth(), lastLogin.getUTCDate(), lastLogin.getUTCHours() + 1, lastLogin.getUTCMinutes(), lastLogin.getUTCSeconds());
                        ...
                        $.post("/umbraco/surface/account/refreshtoken",
                            ...
                            function (response) {
                                ...
                                if (response.Success) {
                                    ...
                                    countdown = response.Expires * 60 * 1000;
                                }
                                else {
        ...
        $.get('/umbraco/surface/account/logout',
            function (data) {
                ...
                if (Cookies.get('lang-url') !== undefined) {
                    document.location.href = Cookies.get('lang-url');
                } else {
